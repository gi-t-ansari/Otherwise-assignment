...
function Login({}) {
    ...
    const handleLogin = () => {
      ...
      else if (storedUserData.email === email && storedUserData.password === password) {
        navigate("/dashboard")
      } else {
  ...
  return (
    <div>
        ...
        <div className='login-input-container'>
            ...
            <p className='login-para'>New User ? <Link style={{textDecoration: "none"}} to="/signup"><span>Sign Up</span></Link></p>
        </div>
    </div>
  )
}
