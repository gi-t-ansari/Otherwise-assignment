    ...
    <div>
        ...
        <div className='signup-input-container'>
            ...
            <form className='signup-form'>
              ...
              {name && email && phoneNumber && password ? <button className='signup-button' onClick={handleSignUp}>sign up</button> : <button className='disabled-signup-button' disabled>sign up</button>}
            </form>
